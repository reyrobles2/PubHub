 ...
 */
@WebServlet("/DeleteTagConfirm")
public class DeleteTagConfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteTagConfirmServlet() {
        super();
...
// passing my variable to the request attribute to the other servlet
				request.getRequestDispatcher("tagDetailsDeleteConfirm.jsp").forward(request, response);
