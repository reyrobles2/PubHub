...
@WebServlet("/ViewTagDetailsDelete")
public class ViewTagDetailsDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewTagDetailsDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// The tagDetailsDelete.jsp page needs to have the details of the selected tag saved to the request,
