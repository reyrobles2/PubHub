...
public class BookDAOImpl implements BookDAO {
	...
	public List<Book> getAllBooks() {
		...
		try {
			...
			String sql = "SELECT * FROM Books ORDER BY isbn_13";			// Our SQL query
	...
	public List<Book> getBooksByTitle(String title) {
		...
		try {
			...
			String sql = "SELECT * FROM Books WHERE title LIKE ? ORDER BY isbn_13";	// Note the ? in the query
	...
	public List<Book> getBooksByAuthor(String author) {
		...
		try {
			connection = DAOUtilities.getConnection();
			String sql = "SELECT * FROM Books WHERE author LIKE ? ORDER BY isbn_13";
			stmt = connection.prepareStatement(sql);
	...
	public List<Book> getBooksLessThanPrice(double price) {
		...
		try {
			connection = DAOUtilities.getConnection();
			String sql = "SELECT * FROM Books WHERE price < ? ORDER BY isbn_13";
			stmt = connection.prepareStatement(sql);
