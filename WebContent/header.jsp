...
<link rel="stylesheet" type="text/css" href="resources/styles/custom2.css"/>	
                ...
                <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="divider"></li>
                          <li><a href="BookTagPublishing">Home (Level 101)</a></li>
                          <li class="divider"></li>                          
                          <li><a href="PublishBook">Publish Book</a></li>
                          <li class="divider"></li>
 							<li class="dropdown2">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown2">Book Tagging<b class="caret"></b></a>
                          		<ul class="dropdown-submenu">
                          			<li><a href="Tag">Tag a Book</a></li>
                          			<li class="divider"></li>
