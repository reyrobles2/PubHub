	...
	%>
		...
		<hr class="tag-primary">
		 ...
		 <div class="form-group">		
			<table id= "delTags" class="table table-striped table-hover table-responsive pubhub-datatable">
				<thead>
					<tr>
						<td>ISBN-13:</td>
						<td>Tag Name:</td>
		...
		<p id="delConfirmText"></p><br>		
			...
			<div class="col-sm-offset-4 col-sm-1">
		  	<form action="DeleteTagByISBN" method="post" class="form-horizontal" >
		  	...
		  	<div class="col-sm-offset-4 col-sm-1">				
			<form action="ViewTagDetailsDeleteByISBN" method="get" class="form-horizontal" >
		  		<input type="hidden" class="form-control" name="isbn13" required="required" value="${tag.isbn13}">
				<input type="hidden" class="form-control" name="tagName" value="${tag.tagName}">		
				<input type="hidden" class="form-control" name="radioTagDeletion" value="${radioTagDeletion}">					
			...
			<form action="TagSearchByISBN" method="get" class="form-horizontal" >
		  		<input type="hidden" class="form-control" name="isbn13" required="required" value="${tag.isbn13}">			
				<button type="submit" class="btn btn-info">Tags</button>
		 	</form>
		 	</div>
